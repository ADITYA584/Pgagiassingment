  ...
  return (
    <GlassEffect>
      <div className=" text-primary_text w-full h-[200px] sm:h-[420px] font-bold flex justify-center items-center ">
        ...
        <h1 className=" z-10 text-[1.4rem] sm:text-3xl md:text-4xl lg:6xl text-center sm:leading-[2rem] md:leading-[4rem] bg-gradient-to-r from-[#6a6eec] to-[#FFFFFF] text-transparent bg-clip-text pb-5 md:pb-0 ">
