        ...
        >
          ...
          <div
            className={
              ...
              `${_props.index % 2 == 0 ? "sm:right-0" : "sm:left-0"}`
            }
          >
          ...
          <div className="flex flex-col z-10  text-primary_text">
            <h1
              className={
                ...
                ` ${_props.index % 2 == 0 ? "md:text-end" : "md:text-start"}`
              }
            >
              {_props.head}
              <p className="text-sm  sm:text-md md:text-lg">{_props.text}</p>
            </h1>
          </div>
        </div>
      </GlassEffect>
